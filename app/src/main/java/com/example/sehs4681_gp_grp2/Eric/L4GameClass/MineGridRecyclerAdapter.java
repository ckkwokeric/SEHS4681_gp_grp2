package com.example.sehs4681_gp_grp2.Eric.L4GameClass;
...
public class MineGridRecyclerAdapter extends RecyclerView.Adapter<MineGridRecyclerAdapter.MineTileViewHolder> {
    ...
    public MineTileViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.lvl4_item_cell, parent, false);
        ...
        public void bind(final Cell cell) {
            ...
            if (cell.isRevealed()) {
                if (cell.getValue() == Cell.BOMB) {
                    valueTextView.setText(R.string.lvl4_bomb);
                ...
                valueTextView.setText(R.string.lvl4_flag);
            }
        }
    }
}